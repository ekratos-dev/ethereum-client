...
const actionModule = function(EthereumClient) {
    class Action {
        ...
        transaction(functionName, listParams, contractValue, senderAddress, senderPrivateKey,transactionDescription=null,transactionValue = null) {
            ...
            if (this.transactions.length > 0) {
                ...
                try {
                    ...
                    for (let i = 0; i < this.transactions.length; i++) {
                        const resultTransaction = await this.sender.getTransactionData(
